...
const zh = {
  ...
  early: '失败：离得太远',
  earlyFailTitle: '挑战无效',
  earlyFailReason: '你停在了安全观景区',
  earlyFailRule: '未进入断崖警戒线',
  roundScore: '本关得分',
  nextCharacter: '下一位角色',
  retryRound: '本关重试',
  nextCrew: '下一位上场',
...
const en: typeof zh = {
  ...
  great: 'BEAUTIFUL!',
  safe: 'SAFE STOP',
  early: 'FAILED: TOO FAR FROM EDGE',
  earlyFailTitle: 'RUN INVALID',
  earlyFailReason: 'You stopped in the safe viewing zone',
  earlyFailRule: 'CLIFF ZONE NOT REACHED',
